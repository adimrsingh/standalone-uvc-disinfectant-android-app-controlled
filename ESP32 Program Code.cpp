...
#define RelayPin2 22  //D22 Buzzer Pin
...
int toggleState_2 = 0; //Define integer to remember the toggle state for buzzer
...
//  Serial.println(bt_data);
  ...
  switch(bt_data)
      {
        case 'A': digitalWrite(RelayPin1, LOW);  toggleState_1 = 0; digitalWrite(RelayPin2, HIGH);  toggleState_2 = 1; break; // if 'A' received Turn on Relay1
        case 'a': digitalWrite(RelayPin1, HIGH); toggleState_1 = 1; digitalWrite(RelayPin2, LOW); toggleState_2 = 0; break; // if 'a' received Turn off Relay1
